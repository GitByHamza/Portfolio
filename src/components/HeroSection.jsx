  ...
  return (
    <section id="hero" className="w-full bg-[#F6F5F0] dark:bg-[#0F0F11] border-b border-[rgba(15,15,15,0.14)] dark:border-[rgba(255,255,255,0.12)] transition-colors duration-200">
      ...
      <div className="px-4 sm:px-8 pt-10 sm:pt-16 pb-8 border-b border-[rgba(15,15,15,0.14)] dark:border-[rgba(255,255,255,0.12)]">
        <FadeIn direction="up" duration={0.7} distance={22}>
      ...
      <StaggerContainer staggerDelay={0.12} className="grid grid-cols-1 lg:grid-cols-12 border-b border-[rgba(15,15,15,0.14)] dark:border-[rgba(255,255,255,0.12)]">
        {/* ── Left Column: Profile & Tools (4 cols) ── */}
        <StaggerItem className="lg:col-span-4 p-6 sm:p-8 lg:border-r border-[rgba(15,15,15,0.14)] dark:border-[rgba(255,255,255,0.12)] flex flex-col justify-between space-y-8">
        ...
        <StaggerItem className="lg:col-span-5 p-6 sm:p-8 lg:border-r border-[rgba(15,15,15,0.14)] dark:border-[rgba(255,255,255,0.12)] bg-[#FAF9F5] dark:bg-[#161619] flex flex-col justify-center relative overflow-hidden">
          ...
          <div className="relative z-10 bg-white dark:bg-[#121215] border border-[rgba(15,15,15,0.18)] dark:border-[rgba(255,255,255,0.12)] shadow-sm p-5 space-y-4 card-hover-guided">
            ...
            <div className="grid grid-cols-3 gap-2 font-mono text-center text-[10px]">
              <div className="p-2.5 border border-[rgba(15,15,15,0.12)] dark:border-[rgba(255,255,255,0.08)] bg-[#FBFBF9] dark:bg-[#1A1A1E] hover:border-[#08966a] transition-colors">
        ...
        <StaggerItem className="lg:col-span-3 p-6 sm:p-8 flex flex-col justify-between space-y-6 font-mono text-xs">
          ...
          <div className="pt-4 border-t border-[rgba(15,15,15,0.1)] dark:border-[rgba(255,255,255,0.1)]">
            <Link
              to="/about"
              className="text-[11px] font-semibold text-[#0F0F0F] dark:text-[#EDECE6] hover:text-[#059669] dark:hover:text-[#10B981] transition-colors flex items-center justify-between group"
            >
