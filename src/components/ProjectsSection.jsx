...
const ProjectsSection = () => {
  ...
  return (
    <section id="work-section" className="w-full bg-[#F6F5F0] dark:bg-[#0F0F11] border-b border-[rgba(15,15,15,0.14)] dark:border-[rgba(255,255,255,0.12)] transition-colors duration-200">
      {/* ─── Section Header ─── */}
      <div className="px-4 sm:px-8 py-12 sm:py-16 border-b border-[rgba(15,15,15,0.14)] dark:border-[rgba(255,255,255,0.12)] flex flex-col md:flex-row md:items-end justify-between gap-6">
        <div>
          ...
          >
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
              ...
              <div className="lg:col-span-7 space-y-5">
                ...
                <div className="pt-4 flex flex-wrap items-center gap-4">
                  <Link to={project.caseStudyUrl} className="btn-outline text-xs">
                    {t('projectsSection', 'view_case')} <ArrowRight size={13} />
                  </Link>
              ...
              <div className="lg:col-span-5">
                <Link to={project.caseStudyUrl} className="block group">
                  <div className="border border-[rgba(15,15,15,0.18)] dark:border-[rgba(255,255,255,0.12)] bg-white dark:bg-[#161619] p-2 shadow-sm transition-all duration-300 group-hover:border-[#059669] dark:group-hover:border-[#10B981]">
      ...
      <div className="p-8 sm:p-12 text-center bg-[#FAF9F5] dark:bg-[#161619] border-t border-[rgba(15,15,15,0.14)] dark:border-[rgba(255,255,255,0.12)]">
        <Link to="/work" className="btn-blue text-xs sm:text-sm px-8 py-4">
          {t('projectsSection', 'view_all')} (8+ SYSTEMS) <ArrowRight size={16} />
        </Link>
      </div>
    </section>
  )
