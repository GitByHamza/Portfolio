export const projectsData = [
...

    {
        ...
        description_ur: "TXS technology aur hardware retailers ke liye tayyar shuda production retail OS hai. Yeh physical branches (maslan Hafeez Centre, Techno City) aur online store ke stock ko ek live screen par yakja karta hai. Isme custom PC Builder engine hai jo CPU sockets AM5/LGA1700, DDR4/DDR5 RAM, power supply wattage aur GPU clearance ko real-time validate karta hai. Hardware serial number lifecycle tracking (IN_STOCK, SOLD, RMA) warranty claims ko asaan banati hai.",
        features: [
